...
#define _m_waiters __u.__vi[sizeof(long)==8?3:2]
#define _m_type __u.__i[sizeof(long)==8?4:3]
#define _m_prev __u.__p[sizeof(long)==8?3:4]
#define _m_next __u.__p[sizeof(long)==8?4:5]
